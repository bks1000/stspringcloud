...
import (
	...
	"github.com/hashicorp/consul/api" //将hashicorp/consul包拷贝到$GOPATH/src/github.com/下
)
...
//golang type
//https://blog.csdn.net/tzs919/article/details/53571632
//golang 数组
//https://www.cnblogs.com/senlinyang/p/8885962.html
type ServiceList []ServiceInfo

//[golang] struct转JSON,解析JSON
//https://blog.csdn.net/shachao888/article/details/53840577
type KVData struct {
	Load      int `json:"load"`
...
var (
	servics_map     = make(map[string]ServiceList) //总结golang之map			https://blog.csdn.net/Soooooooo8/article/details/70163475
	service_locker  = new(sync.Mutex)              //golang基础-互斥锁、读写锁 	https://blog.csdn.net/u013210620/article/details/78357995
